...
Observamos que la versión del servicio FTP es 2.3.4, esta posee una vulnerabilidad como vsftpd 2.3.4 backdoor o CVE-2011-2523. Esta versión de vsftpd contiene un backdoor que, al autenticarse con un usuario terminado en :), abre un shell en el puerto 6200, la cual permite ejecución remota de comandos.
